...
class TablePosWrapper(FactorWrapper):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._default["_random_reset_space"] = copy(self.unwrapped._random_reset_space)
    ...
    def _set_to_factor(self, delta_pos: Tuple[float, float, float]):
        ...
        if not self._default:
            print(
                "WARNING(table_pos): Default positions not set. "
        ...
        self.unwrapped._random_reset_space = spaces.Box(
            ...
            self._default["_random_reset_space"].high + np.tile(delta_pos, num_xyz),
